package ch.supsi.editor2d.frontend.gui.util;
...
import ch.supsi.editor2d.frontend.gui.controller.*;
import ch.supsi.editor2d.frontend.gui.handler.*;
import ch.supsi.editor2d.frontend.gui.model.DataModel;
import ch.supsi.editor2d.frontend.gui.model.FilterCell;
...
public class UIToolkit {
    ...
    public static DataModel buildAndStartStage(Stage stage, Collection<Filter> supportedFilters) throws Exception {
         ...
         */
        // Image View page
        FXMLLoader imageViewLoader = new FXMLLoader(UIToolkit.class.getResource("/view/imageView.fxml"));
        Parent imageView = imageViewLoader.load();
        imageViewLoader.<ImageViewController>getController().initModel(model);

        // About view page
        FXMLLoader aboutLoader = new FXMLLoader(UIToolkit.class.getResource("/view/aboutView.fxml"));
        Stage aboutStage = new Stage();
        aboutStage.setTitle("About Editor2D");
        aboutStage.setScene(new Scene(aboutLoader.load()));

        // Exit view page
        FXMLLoader exitLoader = new FXMLLoader(UIToolkit.class.getResource("/view/exitView.fxml"));
        Stage exitStage = new Stage();
        exitStage.setTitle("Exit");
        exitStage.setScene(new Scene(exitLoader.load()));

        // Main View page
        FXMLLoader mainViewLoader = new FXMLLoader(UIToolkit.class.getResource("/view/mainView.fxml"));
        Parent mainView = mainViewLoader.load();
        MainViewController mainViewController = mainViewLoader.getController();

        // Filter selection View page
        FXMLLoader filterSelectionViewLoader = new FXMLLoader(UIToolkit.class.getResource("/view/filtersListView.fxml"));
        ...
        //Pipeline View page
        FXMLLoader pipelineViewLoader = new FXMLLoader(UIToolkit.class.getResource("/view/pipelineView.fxml"));
        ...
        // Export stage page
        FXMLLoader exportLoader = new FXMLLoader(UIToolkit.class.getResource("/view/exportView.fxml"));
        ...
        // Selectable filters
        ObservableList<Filter> filters = FXCollections.observableArrayList(supportedFilters);
